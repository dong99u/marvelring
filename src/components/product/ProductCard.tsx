...
export default function ProductCard({ product, isLoggedIn: isLoggedInProp, isApproved: isApprovedProp }: ProductCardProps) {
  ...
  return (
    ...
    >
      <div className="relative w-full aspect-square bg-white mb-4 md:mb-6 overflow-hidden ring-1 ring-black/[0.03]">
        {product.main_image_url ? (
          isVideoUrl(product.main_image_url) ? (
            ...
            <Image
              ...
              fill
              className="object-cover transform-gpu group-hover:scale-[1.035] transition-transform duration-700"
